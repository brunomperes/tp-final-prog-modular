 ...
 * @author ThiagoLucas
 */
public class CadastroTécnico extends javax.swing.JFrame {

    /**
     * Creates new form CadastroTécnico
     */
    public CadastroTécnico() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroTécnico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroTécnico().setVisible(true);
            }
        });
    }
