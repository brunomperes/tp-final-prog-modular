 ...
 * @author ThiagoLucas
 */
public class LoginTécnico extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginTécnico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
